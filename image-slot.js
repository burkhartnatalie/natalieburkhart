...
(() => {
  ...
  // sidecar enormous. Raised for full-bleed hero backgrounds (slot renders
  // at full viewport width, often 1920px+): a 2400px WebP at q=0.9 stays
  // sharp on large screens and is still ~300-600KB.
  const MAX_DIM = 2400;
